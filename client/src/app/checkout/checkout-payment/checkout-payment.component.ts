...
export class CheckoutPaymentComponent implements OnInit {
  ...
  @ViewChild('cardExpiry') cardExpirtyElement?: ElementRef;
  ...
  ngOnInit(): void {
    loadStripe(
      'pk_test_51OfOTeFu6QaRIooYK6idZlf94HuFNL55VsWcPBIfeC7kqRGPJMPcMjCf0jRSXuDXWv5bpAjwdLDFj3QbtrrVRe6i00dMgq4uMg'
    ).then((stripe) => {
      this.stripe = stripe;
      ...
      if (elements) {
        ...
        this.cardExpiry.mount(this.cardExpirtyElement?.nativeElement);
